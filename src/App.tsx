  ...
  return (
    <main>
      ...
      <section className="hero" id="top">
        <div className="hero-copy"><p className="eyebrow"><Sparkles size={14} /> Fresh. Loaded. Delivered.</p><div className="hero-brand-lockup" aria-label="B&B Burger and Beyond"><strong>B&amp;B</strong><span>BURGER<br />AND BEYOND</span></div><h1>Good food,<br /><em>big mood.</em></h1><p className="hero-intro">Burgers, pizzas, crispy bites, shakes, and comfort food made for the hungry moments that matter.</p><div className="hero-actions"><a className="button button-dark" href="#menu">Explore the menu <ArrowRight size={17} /></a><a className="text-link" href={`https://wa.me/${WHATSAPP_NUMBER}?text=${encodeURIComponent("Hello B&B Burger and Beyond! I would like to know today's special offers.")}`} target="_blank" rel="noreferrer">Order on WhatsApp</a></div><div className="hero-details"><span><Clock3 size={15} /> Free home delivery</span><span><MapPin size={15} /> Mumbai</span></div></div>
